...
@section('content')
    <div class="mb-6">
        <a href="{{ route('issues.show', $issue) }}" class="text-sm text-slate-600 hover:text-indigo-600">&larr; Back to issue</a>
        <h1 class="mt-2 text-2xl font-bold text-slate-900">Edit Issue</h1>
    </div>
